    ...
    <>
      ...
      <section className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 py-12 bg-white">
        ...
        <div className="text-center md:text-left max-w-xl">
          <h1
            className={`text-4xl md:text-5xl font-bold leading-tight text-gray-800 transition-all duration-500 transform ${
              showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <span
              className={`inline-block transition-all duration-500 delay-100 ${
            ...
            <br />
            <span
              className={`inline-block transition-all duration-500 delay-400 ${
                showContent ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
              }`}
            >
              Paw at a Time
          ...
          <p
            className={`text-gray-600 mt-4 transition-all duration-500 delay-500 ${
              showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          <div
            className={`mt-6 flex flex-col md:flex-row items-center justify-center md:justify-start gap-4 transition-all duration-500 delay-600 ${
              showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <button
        ...
        {/* Right Image */}
        <div
          className={`relative mt-10 md:mt-0 transition-all duration-500 delay-700 ${
            showContent ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
          }`}
        >
          <img
